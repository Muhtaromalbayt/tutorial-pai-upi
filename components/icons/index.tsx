 ...
 * Centralized SVG icons to avoid duplication across Header and Footer
 */
...
export const NewspaperIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// Indonesia Flag
export const IndonesiaFlag: React.FC<{ className?: string }> = ({ className = "w-6 h-4" }) => (
    <svg className={`${className} rounded-sm shadow-sm`} viewBox="0 0 30 20">
